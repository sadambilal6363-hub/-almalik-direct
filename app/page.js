...
<img src="https://raw.githubusercontent.com/sadambilal6363-hub/-almalik-direct/main/app/D34DF3E5-4626-4620-93F7-E2EEB9470D74.png" alt="صورة" />
          <p>منصة ايجار وبيع الصناعيات، المحلات التجارية، المكاتب، المستودعات، السكني، الحوطات، مزارع ،  المتاجر والأراضي الاستثماريه في الإمارات، مع تواصل مباشر وبيانات واضحة.</p>
...
>
      ...
      <section className="how shell" id="how">
        ...
        <div className="howGrid">
          ...
          <div><KeyRound/><b>إدارة اعلانك</b><p>يمكن إضافة حسابات ولوحة تحكم للمالك في المرحلة التالية.</p></div>
        </div>
      </section>
      ...
      <a className="floatingWhats" href="https://wa.me/971589650192" aria-label="WhatsApp"><MessageCircle size={22}/><span>واتساب</span></a>
    </main>
  );
}
