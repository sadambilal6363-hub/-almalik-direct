...
const categories = [
  ["صناعية", Factory],
  ["محلات تجارية", Store],
  ["مكاتب", BriefcaseBusiness],
  ["مستودعات", Warehouse],
  ["سكني", HomeIcon],
  ["حوطات", Fence],
  ["متاجر", Building2],
  ["أراضٍ خالية", LandPlot]
];
...
const listings = [
  ...
  {title:"محل شارع رئيسي بواجهة ممتازة", area:"دبي - القوز", type:"محلات تجارية", size:"1,250 قدم²", price:"190,000 د.إ / سنوي", owner:"مالك مباشر", badge:"جديد"},
  {title:"حوطه مسوّرة للتخزين والمعدات", area:"عجمان - الجرف الصناعية", type:"حوطات", size:"15,000 قدم²", price:"165,000 د.إ / سنوي", owner:"مالك مباشر", badge:"فرصة"},
  {title:"مكتب إداري جاهز للشركات", area:"أبوظبي - مصفح", type:"مكاتب", size:"2,100 قدم²", price:"145,000 د.إ / سنوي", owner:"مالك مباشر", badge:"موثق"},
  {title:"أرض خالية للاستخدام التجاري", area:"أم القيوين", type:"أراضٍ خالية", size:"32,000 قدم²", price:"اتصل للسعر", owner:"مالك مباشر", badge:"استثماري"},
  {title:"سكن منظم قريب من الصناعية", area:"رأس الخيمة", type:"سكني", size:"24 غرفة", price:"360,000 د.إ / سنوي", owner:"مالك مباشر", badge:"متاح"}
];
...
https://raw.githubusercontent.com/sadambilal6363-hub/-almalik-direct/main/public/images/DCDC10B3-4F46-4971-B009-2E7988C9F757.png
